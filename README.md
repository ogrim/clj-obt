...
Needless to say, as this is only version 0.0.3, please watch your step (hacks).

## Installation

Simply add the library with Leiningen: `[clj-obt "0.0.3"]` and require `clj-obt.core`
