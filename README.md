...
Needless to say, as this is only version 0.0.4, please watch your step (hacks).

## Installation

Simply add the library with Leiningen: `[clj-obt "0.0.4"]` and require `clj-obt.core`
